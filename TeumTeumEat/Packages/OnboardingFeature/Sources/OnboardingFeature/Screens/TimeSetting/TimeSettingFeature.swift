...
@Reducer
public struct TimeSettingFeature {
    public init() {}
    @ObservableState
    public struct State: Equatable {
        public var leaveTime: Date
        public var returnTime: Date
        public var isLeaveTimePickerPresented = false
        public var isReturnTimePickerPresented = false
        public var enableAlarm: Bool = false
        public var showSettingsAlert = false
        public var selectedDuration: Duration?

        public init(leaveTime: Date? = nil, returnTime: Date? = nil, selectedDuration: Duration? = nil) {
        ...
        public static var defaultLeaveTime: Date {
        ...
        public static var defaultReturnTime: Date {
            var components = DateComponents()
            components.hour = 18
            components.minute = 0
            return Calendar.current.date(from: components) ?? Date()
